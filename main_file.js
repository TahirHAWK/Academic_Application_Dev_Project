    ...
    <body>
      <header id="header">
        ...
        <li><a class="nav-link" href="/students">Students</a></li>
          ...
          <div class="subHeader">
            <form action="/teachers" method="POST"></form>
                <input type="number" placeholder="IDNumber" name="idnumber">
          ...
          <div class="submittedList">
              <table>
                ...
                <tr><td>1802063</td><td>A+</td> <td><input type="submit" value="Edit"></td><td><input type="submit" value="Delete"></td></tr>
    ...
    <header id="header">
      ...
      <div class="submittedList">
          <table>
            ...
            <tr><td>1802063</td><td>4.50 PM</td> <td><input type="submit" value="Edit"></td><td><input type="submit" value="Delete"></td></tr>
